...
// this block takes care of when a user set new value for the timer
document.querySelector('#timerinput').oninput = function() {
  timemin = document.querySelector("#timerinput").value;
  Stop();
